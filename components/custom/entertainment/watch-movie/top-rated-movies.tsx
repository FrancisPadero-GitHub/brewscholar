...
// types
import type { MovieResult } from "@/types/entertainment/movies/top-rated-movies"
...
// Top Rated movies carousel with pagination
      ...
      <div className="group/scroll relative">
        {isFetching ? (
          ...
          <>
            ...
            >
              {movies.map((movie) => (
                <TopRatedMovieCard key={movie.id} movie={movie} />
              ))}
            </motion.div>
