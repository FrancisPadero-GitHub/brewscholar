...
import { Star, Film, ChevronLeft, ChevronRight, Flame } from "lucide-react"
...
// Popular movie card
function PopularMovieCard({ movie }: { movie: MovieResult }) {
...
//  Popular movies carousel with pagination
